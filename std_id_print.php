<div style="width:21cm; height:29.7cm; margin:0px auto;">
<table align="center" style="border:#000000 1px dotted; width:21cm; height:29.7cm;" cellpadding="0" cellspacing="0">
<?php
include("db.php");
$sql_std = "
select 
	...
	t1.`class_sec` as section,
	t1.`year` as year,
	t1.`class_roll` as class_roll, 
	t2.`name` as stu_name, 
	t2.`father_name` as father_name, 
	t2.`mother_name` as mother_name, 
	t2.`pre_address` as address, 
	t2.`emer_mobile1` as contact_no, 
	t3.`branch_name` as branch_name 
from `std_class_info` t1, `std_profile` t2, `std_branch` t3 
where 
	t1.`stu_id`=t2.`stu_id`
	and t2.`branch_id`=t3.`id`
";
...
while($row_std = mysql_fetch_array($res_std))
{
	...
	?>
		<tr>
			<td align="center" width="50%" style="vertical-align:middle; text-align:center;">
				<table align="center" cellpadding="0" cellspacing="0" style="width:7.7cm; height:4.5cm; border:#000000 1px solid;">
					<td align="center" valign="middle">
						<table border="0" cellpadding="0" cellspacing="0" style="width:7.2cm; height:4cm; font-size:10px;">
							<tr>
							...
							<tr>
								...
								<td colspan="3" rowspan="5" valign="top" align="right"><img src="student_profile_picture/profile_image.jpg" style="width:2cm; height:2.5cm; border:#333333 1px dashed; margin-top:-0.2cm;" /></td>
							</tr>
							<tr>
								<td>Student ID</td>
								<td>:</td>
			...
			<td align="center" width="50%" style="vertical-align:middle; text-align:center;">
				<table align="center" cellpadding="0" cellspacing="0" style="width:7.7cm; height:4.5cm; border:#000000 1px solid; font-size:10px;">
					<td align="center" valign="middle">
						<table border="0" cellpadding="0" cellspacing="0" style="width:7.2cm; height:4cm; font-size:10px;">
							<tr>
							...
							<tr>
								<td colspan="3"></td>
								<td align="center" style="border-top:#000000 1px solid;"><strong>Principal</strong></td>
							</tr>
						</table> 
					</td>
				</table>
