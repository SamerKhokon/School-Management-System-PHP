...
<div id="demo">
				...
				// $url='?SM_id='.$_REQUEST['SM_id'].'&menu_id='.$_REQUEST['menu_id'].'&nev=student_profile_information_view';
					...
					$string = "SELECT  * from tbl_class_fee_info where class_id=$class_id and fee_head_id=8 and branch_id=$branch_id";
						...
						while ($row=mysql_fetch_array($qry))
						{
								  ...
								  $qry2="select fee_head from tbl_class_feehead where branch_id=$branch_id and fee_head='transport' and id='$fee_head_id'" ;
