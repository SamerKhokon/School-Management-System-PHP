...
{  
		...
		//$('#group_name').keydown(function(event){    if (event.keyCode == 13){ $('#age').focus();}				});		
		...
		//$('#payslip_no').keydown(function(event){     if (event.keyCode == 13){ $('#sex').focus();}				});	
	...
	{			
		...
		"&group_name="+group_name+"&payslip_no="+payslip_no+"&h_tel="+h_tel+"&pre_address="+pre_address+"&par_address="+par_address+"&emer_name1="+emer_name1
		...
		{
					  //get_ur_adm_info_by_ajax.php	 
					  //$profile_id.'|'.$class_roll.'|'.$section_roll		
		   ...
		   $.ajax({
			  ...
			  success:function(st) {
				 ...
				 {
					$("#profile_id").text(parse[0]);
					$("#class_roll").text(parse[1]);
					$("#section_roll").text(parse[2]); 					
				 }
				 else
				 {
					$("#profile_id").text(' ');
	...
	<div id="content" class="box">
	  ...
	  <fieldset >
            ...
            <table>			       
            	<tr>
                	<th> ProfileID :  <span id="profile_id"></span></th>
                    <th> Section Roll: <span id="section_roll"></span></th>
                    <th>Class Roll: <span id="class_roll"></span></th>
				</tr>
            	<tr>
							...
							<table>
								...
								<input type="hidden" id="emer_email" value=""/>																
									...
									<tr>
										...
										<td><textarea id="pre_address" name="pre_address" row="3" cols="18">		
									</textarea></td>
										<td></td>
									</tr>
