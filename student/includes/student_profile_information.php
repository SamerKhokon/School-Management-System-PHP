...
<div id="content" class="box">  
	...
	<legend>Contact Details</legend>
		<table>
				...
				<tr>
					<th>Present Address:&nbsp;</th><td><input type="text" name="par_address" value="<?php echo $par_address; ?>" /></td><td></td>
	...
	<legend>Parents Details</legend>
		...
		<table>
			<tr>
				<th>Father   Name:</th><td><input type="text" name="father_name" value="<?php echo $father_name; ?>" /></td><td></td>
			...
			<tr>
				<th>Qualification:</th><td><input type="text" name="father_qualification" value="<?php echo $father_qualification;  ?>" /></td><td></td>
				<th>Qualification:</th><td><input type="text" name="mother_qualification" value="<?php echo $mother_qualification; ?>" /></td>
			</tr>
			<tr>
				<th>Work Phone :</th><td><input type="text" name="father_work_phone" value="<?php echo $father_work_phone;  ?>" /></td><td width="16%"></td>
	...
	<table>
		<tr>
			<th>Previous School:&nbsp;</th><td><input type="text" name="priv_school_name" value="<?php echo $priv_school_name;  ?>" /></td><td></td>
		...
		<tr>
			<th>Result:</th><td><input type="text" name="priv_school_result" value="<?php echo $priv_school_result;  ?>" /></td><td width="17%"></td>
