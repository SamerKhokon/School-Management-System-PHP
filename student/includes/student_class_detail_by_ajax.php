...
<?php
		...
		if($sec_name!="all" && $class_id!=""  ) {								
			$where  = " WHERE class_id=$class_id and class_sec='$sec_name' AND branch_id=$branchid";
		}else if($class_id!="" and $sec_name=="all" ){
		    $where = " where branch_id=$branchid and class_id=$class_id";
		}
