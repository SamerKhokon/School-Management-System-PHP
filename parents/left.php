<!-- Aside (Left Column) -->
    <div id="aside" class="box">
      <div class="padding box">
        ...
        <p id="logo"><a href="javascript:void(0);"><img src="tmp/logo.gif" alt="" /></a></p>
        <!-- Search -->
	  ...
	  if (isset($_POST['menu_id']))
	   {
        ...
        <p id="btn-create" class="box"><a href="#"><span><?php echo $row[1];?></span></a></p>
      </div>
      <!-- /padding -->
      <ul class="box">
	  ...
	  <?php 
	   ...
	   $user_sub_menu_id1 =  $_SESSION['SUB_MENU_1']  ;
						  ...
						  // $class_id=$row[6];
						   ...
						   echo "<li id=$par><a href=\"javascript:void(0);\" name=\"acs\" class=\"sub_menu_link\"  id=\"$row[3]\">$row[1]</a>";
									   ...
									   if($sub2!=0 and $par=="submenu-active")
									   {
									    echo "<ul>";
											...
											{
											echo "<li><a href=\"javascript:void(0);\" name=\"acs\" class=\"sub_menu_link\"  id=\"$row_sub2[4]\">$row_sub2[1]</a></li>";
											}
										echo "</ul>";
										}
