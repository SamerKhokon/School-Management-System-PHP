...
$qry = mysql_query("SELECT  * from std_exam_period where id='$period_id'" ); 		
...
function delete_record($period_id)
{
?>
	...
	if (isset($_POST['ok_btn']))
	{
		...
		$res="delete from std_class_period where id=$period_id";
		mysql_query($res);
...
{
	detail_record($period,$start_time,$end_time,$period_id);
}
   
function  detail_record($period,$start_time,$end_time,$period_id)
{
?>
	<fieldset>
	<legend>Detail About Exam Period</legend>
	<table>
...
{
	edit_record($period,$start_time,$end_time,$period_id);
}
function edit_record($period,$start_time,$end_time,$period_id)
{
	...
	{  
		...
		$ress="UPDATE std_exam_period SET period='$period',start_time='$s_time',end_time='$e_time' where id='$period_id'";
