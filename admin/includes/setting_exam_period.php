...
$(document).ready(function(){
	...
	$("#jq_tbl").load('includes/table/exam_period_tbl.php');						  
	...
	$("#class_btn").click(function(event){
		...
		{
			//alert(branchid);
			var dataA = '&period='+period+'&start_hour='+start_hour+'&start_min='+start_min+'&end_hour='+end_hour+'&end_min='+end_min;
			//alert(dataA);
			$.ajax({
				url:'includes/table/exam_period_tbl_insert.php',
				type:'post',
				data:dataA,
				success:function(htmData){
					...
					$('#end_min').val(0);
					$('#break_flag').val(0);
					$("#jq_tbl").load('includes/table/exam_period_tbl.php');											 					$("#period").focus();
				},
...
<legend>Add New Exam Period</legend>
