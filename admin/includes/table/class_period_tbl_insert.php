<?php
	...
	$sel="select count(*) as chk from std_class_period where period='$period' and branch_id='$branch_id'";
	...
	{ 
		...
		$ins_sql="insert into std_class_period(period, start_time, end_time, entry_date, break_flag, branch_id, flag) values('$period', '$start_time', '$end_time', now(), $break_flag, '$branch_id', 1)";
