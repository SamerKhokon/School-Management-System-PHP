...
function edit_record($period,$start_time,$end_time,$break_flag,$branch_id,$period_id)
{
	...
	{  
		...
		echo $ress="UPDATE std_class_period SET period='$period',start_time='$s_time',end_time='$e_time',break_flag='$break_flag' where period_id='$period_id' and branch_id='$branch_id'";
