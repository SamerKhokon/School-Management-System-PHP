...
<?php require_once("../db.php"); ?>
    <div id="aside" class="box">
      <div class="padding box">
        <p id="logo"><a href="javascript:void(0);">
		<img src="tmp/logo.gif" alt="logo" /></a></p>
<?php   session_start();  $user_type = $_SESSION['USER_TYPE'];
...
?>	
      ...
      <!-- /padding -->
      <ul class="box">	  
	  <?php 	 $user_sub_menu_id1 = $_SESSION['SUB_MENU_1'];  
		if($user_type!='Admin')
			$query = "select * from sub_menu1 where id in ($user_sub_menu_id1) and main_menu_id=$main_manu_id order by order_id";
		else
			$query = "select * from sub_menu1 where main_menu_id=$main_manu_id order by order_id";
