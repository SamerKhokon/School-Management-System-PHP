...
$SQL = "SELECT id, class_name, no_of_student, total_CT,total_st, daily_class,class_start_time FROM std_class_config $where ORDER BY $sidx $sord LIMIT $start , 
$limit";  
...
echo "<row id='". $row['id']."'>";             
            ...
            echo "<cell>". $row['total_CT']."</cell>"; 			
			echo "<cell>". $row['total_st']."</cell>"; 
                               //echo "<cell><![CDATA[". $row['note']."]]></cell>";
			echo "<cell>". $row['daily_class']."</cell>"; 
			echo "<cell>". $row['class_start_time']."</cell>"; 
