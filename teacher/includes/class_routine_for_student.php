					...
					for($r=0; $r<$no_of_row; $r++)
					{
						...
						if($r==0)
						{
							for($col=0; $col<$no_of_column; $col++)
							{
								if($col==0)
								{
									echo '<td class="tbl_routine_new_td" style="background-color:#eaeaea">Day/Period</td>';
								}
								else
								{
									if($col==$break_period)
						...
						else
						{
							for($col=0; $col<$no_of_column; $col++)
							{
								if($col==0)
								{
									echo '<td class="tbl_routine_new_td" style="background-color:#eaeaea"><strong>'.$day_array[$r].'</strong></td>';
								}
								else
								{
									$d = $r;
