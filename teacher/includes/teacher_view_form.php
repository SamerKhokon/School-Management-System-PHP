...
<div id="content" class="box">
    ...
    <fieldset>
        ...
        <table border="0" cellpadding="0" cellspacing="0" >
		    <?php if($pic=="") { $pic ="profile_image.jpg";}else{$pic ="profile_image.jpg"; } ?>
            <tr>
			    <td width="17%"><img src="../student_profile_picture/<?php echo $pic;?>" width="100" height="100"/></td>
				<td></td><td></td><td></td><td></td>
			</tr>
            <tr>			
                <th width="17%" valign="top">Name:</td>
				<td><?php echo $name;   ?></td>
                <td></td><td width="18%"></td>
    ...
    <table><tr>
<td>    <a href="?SM_id=13&nev=teacher_information&menu_id=15">
<input type="button" id="sub_btn" name="sub_btn" class="form-back"/></a> </td><td width="90%"></td>
<td>  <!--  <input type="button" id="sub_btn" name="sub_btn" class="form-update"/>-->
</td>
</tr></table>
