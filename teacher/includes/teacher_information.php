...
<table cellpadding="0" cellspacing="0" border="0" class="display" id="example">
 ...
 //$url='?SM_id='.$_REQUEST['SM_id'].'&menu_id='.$_REQUEST['menu_id'].'&nev=teacher_view_form';
...
$qry = mysql_query("SELECT  * from std_teacher_info where branch_id='$branchid'");
		...
		while ($row=mysql_fetch_array($qry)){
			...
			<td><a href="includes/teacher_view_form.php?tid=<?php echo $tid;?>" onclick="return GB_showCenter('Detail Data', this.href,800,980);">
			<?php echo $teacher_name;?></a></td>
