<script type="text/javascript">
 $(document).ready(function(){
    $('#pass_student_list').load('includes/pass_std_list_by_ajax.php',function(){}); 
});	
</script>
