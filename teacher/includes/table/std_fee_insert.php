...
$sel="select count(*) as chk from tbl_class_feehead where fee_head='$fee_name'";
...
$ins_sql="insert into tbl_class_feehead(fee_head,category,branch_id) values('$fee_name','$category','$branch_id')";
    ...
    $in_ql=mysql_query("SELECT id FROM tbl_class_feehead where fee_head='$fee_name' ");
...
<?php
	  ...
	  {
	  $sel2="select id from std_class_config ";
