...
<?php
		...
		$string = "SELECT id, teacher_id, date_format(month,'%b-%Y') as month_name, total_open, total_attend, total_absent, branch_id FROM `tbl_teacher_attendance_info` WHERE branch_id=$branch_id";			
