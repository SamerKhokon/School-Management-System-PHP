<div id="menu" class="box">
    <ul class="box f-right">
	  ...
	  $main_menu_str = "SELECT id,main_name FROM main_menu WHERE flag='ref_home'"; 
	...
	if(strtolower($user_type)=='admin') {
		...
		$query_head="select * from main_menu where id in (25,26,42,43)";
	}
  ...
  $(document).ready(function(){
	...
	$(".sub_menu_link").live("click",function(){
		...
		$("#ur_content").load("includes/"+sub_id+".php");
	});*/
  });
  </script>
