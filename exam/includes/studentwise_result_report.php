...
<script type="text/javascript">
	...
	{
		var search_report = function(class_id,student_id,year_id,term_id)
		{
		//alert(class_id+"  "+student_id+"  "+year_id +"  "+term_id);
			window.showModalDialog("../result_sheet/studentwise_result_report.php?class_id="+class_id+"&student_id="+student_id+"&year="+year_id+
        ...
        $('#term_result').click(function(){
			...
			search_report( class_id , student_id , year_id , term_id );			
		});		
...
<div id="content" class="box">
    ...
    <fieldset>
		    <legend>Studentwise Term Result Report</legend>
				...
				<td>Student Id</td>
				<td>
					 <input type="text" id="student_id"  class="inp-form" />						 												  
				</td>
				</tr>		
				<tr> <th>&nbsp;</th> </tr>	
				<tr>
