<?php		include("../db.php");
				 ...
				 if($chk_count > 0) 
				 {
					 $str = "select subjective_mark,objective_mark,ct_mark,year,period from std_class_exam_mark_setting where stu_id=$roll and sub_id='$subject_id' and class_id=$class_id and branch_id=$branchid";				 
					 $sql =  mysql_query($str);
					 ...
					 echo $sb_mark."|".$ob_mark."|".$ct_mark."|".$year."|".$period;
