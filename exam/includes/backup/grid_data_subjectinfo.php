...
$result = mysql_query("SELECT COUNT(*) AS count FROM std_subject_config $where");  
...
$SQL = "SELECT id, subject_name, sub_mark, ct_mark,st_mark, final_mark FROM std_subject_config $where ORDER BY $sidx $sord LIMIT $start , 
$limit";  
...
echo "<row id='". $row['id']."'>";             
            ...
            echo "<cell>". $row['sub_mark']."</cell>"; 
            echo "<cell>". $row['ct_mark']."</cell>"; 
			
			echo "<cell>". $row['st_mark']."</cell>"; 
            //echo "<cell><![CDATA[". $row['note']."]]></cell>";
			echo "<cell>". $row['final_mark']."</cell>"; 
