<div id="menu" class="box">
			...
			<ul class="box">	
						<?php   
								...
								{
									$query_head = "select * from main_menu where id in (21,22,37,38,39,40,41) order by order_id";
								}
								else if( strtolower($user_type) == 'admin') 
								{
									$query_head = "select * from main_menu";	
								}
								...
								{	
									   ...
									   echo "<li><a href=\"javascript:void(0);\" class=\"menu_link\" id=\"$row_head[0]\"><span>";
									   echo $row_head[1];
									   echo "</span></a></li>";	   	   
								}		
						?>	
...
$(document).ready(function(){
	$(".menu_link").click(function(){
		...
		$("#left_menu").load("left.php" ,{"menu_id":$("#main_menu_container").val()}, function(){});
	});
	...
	$(".sub_menu_link").live("click",function(){
		...
		//alert(parse[2]);
		//"includes/"+link_id+".php"
		$("#your_content").load("includes/"+parse[2]+".php",function(){});
	});*/
});
</script>