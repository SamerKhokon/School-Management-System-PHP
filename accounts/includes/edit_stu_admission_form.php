<?php	include('db.php');			
		...
		'$father_wrk_phone','$mother_wrk_phone','custom','$pre_school_name','$pre_school_add', '$pre_class','$pre_class_roll','custom','$pre_class_result','$className','custom','custom','$branchid');";		
