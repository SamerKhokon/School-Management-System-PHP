	...
	{ 
	   ...
	   $("#payment_check_submit").click(function() {
			...
			else if(class_sec=="") 
			{
				...
				$('#payment_checked_table').load('includes/payment_checked_total_amount.php',
...
<tr><td>&nbsp;</td><td>&nbsp;</td></tr>			   				
				...
				<tr>	
					 <th>&nbsp;</th> 
					 <td> 
					 <input type="button" id="payment_check_submit" class="form-submit" value="Submit" />
					 </td>
				</tr>										
				</table>
				...
				<br/><br/>
				<div id="payment_checked_table"></div>
	</fieldset>	
</div>