...
<?php           require_once('../db.php');
				...
				$where = " WHERE 1=1 AND class_id=$class_id AND 
				month_date='$month_date' AND month='$month_year' and status='$status_id'";								
				
				$str = "SELECT id,std_id,std_name,class_id,class_name,section,class_roll,
				DATE_FORMAT(`month_date`,'%b-%Y') AS `month_name`, 
				STATUS,amount,branch_id,status FROM std_fee_collection ".$where;
