...
<select name="district" class="form_input">
...
?>
   <select name="division" class="form_input">
   <option value="Dhaka">Dhaka</option>
<?php
...
<select name="married" class="form_input">
...
<option value="Marrid">Unmarried</option>
 ...
 <samp class="button_po"> <input name="submit" type="submit" value="Update" class="buttons" /> </samp>
