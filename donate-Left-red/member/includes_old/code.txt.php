...
function GenerateTree($memberid)
{
	...
	echo "<tr><td  colspan='3' style='text-align:center;color:#000000; padding:0px 20px 0px 0px;display:block; width:700px;'><img  width='90' height='70' src=\"img/member.jpg\"/><br/>Login ID: ".$memberid.getInfo($memberid)."<br />"."</td></tr>";
    echo "</table>"	;
	echo "<table border='0' class='mainTable' style='width:100%'><tr><td><img width='710' src=\"img/tree.jpg\"/></td></tr></table>";
	...
	echo "<table border='0' class='mainTable' cellspacing='0' cellpadding='10' style='width:100%'>\n";	
	echo "<tr><td style='width:33%; color:#000000;padding:0px 0px 0px 0px;'><br/><img width='230' src=\"img/line2.jpg\"/>".$l1."</td>
	<td style='width:33%;color:#000000; padding:0px 0px 0px 0px;'><br/><img width='230' src=\"img/line2.jpg\"/>".$l2."</td>
	<td style='width:34%;color:#000000; padding:0px 0px 0px 10px; '><br/><img  width='230' src=\"img/line2.jpg\"/>".$l3."</td></tr>";
	echo "</table>\n";
...
$paremeter="?nev=".$pagetitle."&menu_id=".$menu_id."&SM_id=".$sub_menu_id;
	...
	$sno_row=mysql_fetch_array($sno_result);
		...
		{
		$final .= "<td style='width:33%; padding:0px 100px 0px 0px; /*background-color:#FFFFEC;*/' title='".getToolTip($row["login_id"])."'>
	...
	$final .= "<td style='width:33%;'><img src='img/memberadd.jpg' width='50' height='50' alt='No Record' longdesc='#' />$linkA</td>
               <td style='width:33%;padding:0px 0px 0px 50px;'><img src='img/memberadd.jpg' width='50' height='50' alt='No Record' longdesc='#' />$linkB</td>
			   <td style='width:34%; padding:0px 0px 0px 50px;'><img src='img/memberadd.jpg' width='50' height='50' alt='No Record' longdesc='#' />$linkC</td>"; 
    }
	if($x==2 && $pre=="B")
	{
	...
	if($x==1 && $pre=="A")
	{
	$final .= "<td style='width:33%;Padding:0px 0px 0px 150px;'><img src='img/memberadd.jpg' width='50' height='50' alt='No Record' longdesc='#' />$linkB</td>
	<td style='width:34%; Padding:0px 0px 0px 310px;'><img src='img/memberadd.jpg' width='50' height='50' alt='No Record' longdesc='#' />$linkC</td>";
	}
