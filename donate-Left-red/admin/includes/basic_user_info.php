    ...
    <fieldset class="basicc" >			
	  <legend >Sponsor Details </legend>
        ...
        <table>
         ...
         <tr><td width="40px"> </td><td>Sponsor Name </td><td>: <?php echo $sponsor_id ?> </td>
		 <td width="140px"> </td> <td> Form Type </td><td>:<?php echo $form_type ?></td> </tr>
		 <tr><td width="40px"> </td><td>Nominee Name </td><td>: <?php  ?> </td>
		 <td width="140px"> </td> <td> Relatio with Nominee </td><td>:<?php  ?></td> </tr>
		 </table>
	  </fieldset>
</div>
    ...
    <fieldset class="basicc" >			
	  <legend >Personal Details </legend>
        ...
        <table>	  	 
		 ...
		 <tr><td> </td> <td> Member Name </td><td>:    <?php echo $member_name ?></td> 
         <td> </td> <td> Date of Birth </td><td>:  <?php echo $member_date_of_birth ?></td></tr> 
			   
			
         <tr><td width="40px"> </td> <td> Marital Status </td><td>: <?php echo $married_status ?></td>
         <td width="190px"></td><td> Address</td><td> : <?php echo $address ?></td></tr> 	   
...
<div class="basic">
	<fieldset class="basicc">
		...
		<table>
		  ...
		  <tr> <td width="40px"></td><td> Mail Address</td><td> :   <?php echo $mail_address ?></td>
          <td width="170px"></td><td> Nationality </td><td>:    <?php echo $nationality ?></td></tr>
		  
		  <tr> <td ></td><td> City </td><td>: <?php echo $city ?></td>
          <td> </td> <td> State </td><td>: <?php echo $state ?></td></tr> 
   	  
          <tr> <td></td> <td> Mobile No</td><td> :      <?php echo $mobile_no ?></td> 
          <td> </td> <td> Email</td><td> :          <?php echo $email ?></td></tr>
		 </table> 
</fieldset>
</div>		
<div class="basic">
	<fieldset class="basicc">
		<legend>Other Details </legend>
         <table>
           <tr> <td width="40px"></td><td> Create Time</td><td> :    <?php echo $create_date ?></td>
           <td width="230px"></td> <td> Bank Name </td><td>:      <?php echo $bank_name ?></td></tr> 
		   
           <tr> <td> </td> <td>Account NO </td><td>:     <?php echo $acc_no ?></td>   
           <td></td><td> Bank Branch </td><td>:    <?php echo $bank_branch ?></td></tr>  		
         </table>	   
     </fieldset>
