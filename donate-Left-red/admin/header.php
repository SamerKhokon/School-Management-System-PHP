...
//	   $sql_menu="select * from user_acl where user_id=$user_id";
	   $sql_menu="select user_type,(select main_menu from user_acl_group where id=user_group_id ) as main_menu,(select sub_menu1 from user_acl_group where id=user_group_id ) as sub_menu1 from user_acl where user_id=$user_id";
	...
	{	
	   ...
	   echo "<li><a href='javascript:void(0);' id='11' class='tp_link'><span>";
	   echo $row_head[1];
       echo "</span></a></li>";	   	   
	}
		
	?>
	<input type="hidden" id="main_menu_id" value=""/>
  <!--
