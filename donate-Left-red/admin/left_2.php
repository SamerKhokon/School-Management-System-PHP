<!-- Aside (Left Column) -->
    <div id="aside" class="box">
	  ...
	  <?php 
						   ...
						   if($user_type!='Admin')
						   $query="select * from sub_menu1 where sub_menu_id in ($user_sub_menu_id1) and main_menu_id=$main_manu_id";
						   else
						   ...
						   echo "<li id=$par><a href=\"?SM_id=$par&menu_id=$main_manu_id&nev=$row[3]&class_id=$class_id\">$row[1]</a>";
