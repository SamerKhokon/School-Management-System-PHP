  ...
  <table width="100%" cellpadding="0" cellspacing="3">
	...
	<td style="width:350px;border-left:1px solid #000;border-top:1px solid #000;border-right:1px solid #000;border-bottom:1px solid #000;">
				<table border="0" cellpadding="0" cellspacing="0" >
					...
					<tr>
						<td colspan="4" align="center" style="font-style:bold;text-align:center;"><?php echo $school_name;?><br />
							<?php echo $school_address;?>
						</td>
					</tr>
					<tr><td>&nbsp;</td></tr>
					<tr><td  colspan="4"  style="font-style:italic;text-align:center;">Identity Card</td><td ></td></tr>
					<tr><td>&nbsp;</td>	</tr>
					<tr>
						<td>Student ID</td>
						<td>:</td>
