<?php   ob_start();  															
	...
	<p style="text-align:center;">
		...
		<span style="font-size:10px;font-family:Arial;"><?php echo $school_address;?></span>     &nbsp; &nbsp;<br/>
		<span style="font-size:10px;font-family:Arial;">Phone:7593593795793</span>     &nbsp; &nbsp;<br/>
		<span style="font-size:12px;text-decoration:underline;font-family:Arial;">Salary Sheet(Jul-2013)</span><br/>
	</p>
	</td></tr>
	</table>
		<br/>	
	...
	<table align="center" cellpadding="0" cellspacing="0" border="0">
		...
		<th rowspan="2" style="width:50px;text-align:center;border-left:1px solid #000;border-top:1px solid #000;border-bottom:1px solid #000;border-right:1px solid #000;">Gross Amount</th>
		...
		<td style="width:70px;text-align:center;border-left:1px solid #000;border-top:0px solid #000;border-bottom:1px solid #000;border-right:1px solid #000;"></td> 							
		  ...
		  <td colspan="13" style="width:50px;text-align:center;border-left:1px solid #000;border-top:0px solid #000;border-bottom:1px solid #000;border-right:1px solid #000;"></td>
		  </tr>
	</table>
